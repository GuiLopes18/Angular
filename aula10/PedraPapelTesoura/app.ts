...
const papelButton = document.getElementById("pedra") as HTMLElement;
const tesouraButton = document.getElementById("pedra") as HTMLElement;
...
function jogar(escolha) {
    ...
    const resultado = `Seu movimento = ${jogadas[escolha]} ${jogadas[compMove]} = Movimento do computador`;
